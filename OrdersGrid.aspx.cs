...
public partial class OrdersGrid : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("delete FROM Orders where OrderID='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
        Response.Redirect("OrdersGrid.aspx");
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        TextBox ShipVia = (TextBox)row.FindControl("ShipVia");
